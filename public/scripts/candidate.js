...
socket.on("admin-candidate-update-candidate", (candidates) => {
    ...
    for(id in candidates){
        ...
        galery.innerHTML = `
            <img class="w-full h-[220px] object-cover border-0" src="${candidates[id].foto}" alt="">
            <div class="mt-2">
        ...
        table.innerHTML = `
            ...
            <td>${candidates[id].visi.slice(1, 31)}....</td>
            <td>${candidates[id].misi.slice(1,31)}....</td>
            <td>
                <button class="inline-flex items-center justify-center rounded-sm border-b-3 border-blue-600 w-7 h-7 bg-blue-500">
                ...
                <button class="inline-flex items-center justify-center rounded-sm border-b-3 border-green-600 w-7 h-7 bg-green-500">
                    <svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button class="inline-flex items-center justify-center rounded-sm border-b-3 border-red-600 w-7 h-7 bg-red-500">
                    <svg width="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
